!function() {
    ...
    module.exports = new Class({
        ...
        /**
         * laod all hosts for the currrent
         * cluster config
         */
        , load: function(configuration) {
            ...
            this.driverName = this.config.getDriverName();
            ...
            // laod cluster
            return Promise.all(this.config.getHosts().map((config) => {
            ...
            if (!type.object(queryContext)) return Promise.reject(new Error('Expected a query context object!'));
                ...
                if (!queryContext.isReady() && queryContext.ast) {
                    return this.compiler.compile(queryContext).then(() => {
                        queryContext.sql += ';';
                        return this.query(queryContext).then((data) => {
         ...
         *
         * @param {object} queryContext the query context
         *
         * @returns {Promise} 
         */
        ...
        /**
         * processes the results of an ast query
         *
         * @param {object} queryContext the query context
         * @param {object} data returned from the db
         *
         * @returns {Promise} 
         */
        , processASTQueryResult: function(queryContext, data) {
            return this.compiler.process(queryContext, data);
        }
