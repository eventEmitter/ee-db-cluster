(function() {
	...
	module.exports = new Class({
		...
		// as idle connections
		, idle: {
			get: function() { //log.highlight(this.idleCount, this.creatingCount, this.maxConnections);
		 ...
		 */
		, createConnection: function() { //log.warn(this.ended, this.idle, this.prefetchPercent, this.count, this.maxConnections);
		 ...
		 */
		, executeCreateConnection: function() { log(this.config);
